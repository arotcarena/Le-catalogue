...
<nav class="navbar navbar-expand navbar-dark bg-dark" aria-label="Second navbar example">
    ...
    <div class="container mt-4">
        ...
        <nav class="navbar navbar-expand">
            <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <h4><?= $nav->link($router->url('details'), 'Informations personnelles', 'match_2', '" style="font-weight: bold;"') ?></h4>
                    </li>
                    <li class="nav-item">
                        <h4><?= $nav->link($router->url('address_listing'), 'Mes adresses', 'match_2', '" style="font-weight: bold;"') ?></h4>
                    </li>
                    <li class="nav-item">
                        <h4><?= $nav->link($router->url('orders_listing'), 'Mes commandes', 'match_2', '" style="font-weight: bold;"') ?></h4>
                    </li>
            </ul>
        </nav>
